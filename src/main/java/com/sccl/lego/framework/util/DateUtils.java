...
public final class DateUtils {
    ...
    public static String convertDateStrToStr(String dateStr, String oldPattern, String newPattern) {
        try {
            ...
            log.debug("时间格式化异常-->" + dateStr + ",old=" + oldPattern + ",new=" + newPattern + "-->" + e.getMessage());
        }
        return null;
    }
    ...
    public static Date getDate(Long time) {
        ...
        try {
            ...
            log.debug("时间格式化异常-->" + time + "-->" + e.getMessage());
        }
        return date;
    }
    ...
    public static long getCountDown() {
        ...
        try {
            ...
            log.debug("时间格式化异常-->" + ddd + "-->" + e.getMessage());
        }
    ...
    public static void main(String[] args)
    {
        ...
        Date beginDate = StrToDateTime("2016-07-12", pattern);
        Date endDate = StrToDateTime("2016-08-12", pattern);
        int splitType = 3;
        List<String[]> retList = splitTime(beginDate, endDate, splitType, pattern);
        for(String[] strs : retList)
        {
        ...
        System.out.println(getStrDate(beginDate));
    }
}
